 ...
 * @see org.wltea.analyzer.lucene.IKTokenizer
 * 这个作者没加传入外部配置的参数,所以这里加一下
 */
public final class ExtConfigIKTokenizer extends Tokenizer {
     ...
     * @param useSmart
     */
    public ExtConfigIKTokenizer(boolean useSmart) {
    ...
    public ExtConfigIKTokenizer(Configuration configuration) {
        offsetAtt = addAttribute(OffsetAttribute.class);
        termAtt = addAttribute(CharTermAttribute.class);
        typeAtt = addAttribute(TypeAttribute.class);
